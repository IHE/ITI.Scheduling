This section corresponds to transaction [ITI-116] of the IHE Technical Framework. Transaction [ITI-116] is used by the Scheduling Client and Scheduling Server Actors. The Find Appointments [ITI-114] transaction is used to provide a set of parameters to the server, and based on them to get back a list of possible appointments.
